function InclineDeclineFigure6V2(SMatrix,RF, RK, groups)
close all
...
CorrelationsSingle(SMatrix, RF,['TMafter'],{'netContributionNorm2'}, RF,['EarlyA'],{'FyPSmax'}, groups, [], 2, 3, 1, 1000, 1)
CorrelationsSingle(SMatrix, RF,['DelFAdapt'],{'FyPSmax'}, RF,['EarlyA'],{'FyPSmax'}, groups, [], 2, 3, 2, 1000)
CorrelationsSingle(SMatrix, RF,['TMafter'],{'FyPFmax'}, RF,['DelFAdapt'],{'FyPSmax'}, groups, [], 2, 3, 3, 1000)
CorrelationsSingle(SMatrix, RF,['TMafter'],{'XFast'}, RF,['TMafter'],{'FyPFmax'}, groups, [], 2, 3, 4, 1000)
CorrelationsSingle(SMatrix, RF,['TMafter'],{'stepLengthSlow'}, RF,['TMafter'],{'XFast'}, groups, [], 2, 3, 5, 1000)
CorrelationsSingle(SMatrix, RF,['TMafter'],{'netContributionNorm2'}, RF,['TMafter'],{'stepLengthSlow'}, groups, [], 2, 3, 6, 1000)
...
%CorrelationsSingleXYABS(SMatrix, YallDATA,XallDATA, groups, Parameters, paramLabels, [], 1, 1, 1, 54, 1, epochLabels)
%CorrelationsSingleXYNoInterceptABS(SMatrix, YallDATA,XallDATA, groups, Parameters, paramLabels, [], 1, 1, 1, 54, 1, epochLabels)
...
%CorrelationsSingleXYABS(SMatrix, YallDATA_PA,XallDATA_PA, groups, Parameters, paramLabels, [], 1, 1, 1, 55, 1, epochLabels)
%CorrelationsSingleXYNoInterceptABS(SMatrix, YallDATA_PA,XallDATA_PA, groups, Parameters, paramLabels, [], 1, 1, 1, 55, 1, epochLabels)
