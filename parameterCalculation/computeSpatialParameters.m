...
aux={'direction',               '-1 if walking towards window, 1 if walking towards door (implemented for OG bias removal and coordinate rotation)';...
    ...
    'swingSpeedSlow',   'swingRangeSlow divided by swingTimeSlow';...
    'swingSpeedFast',   'swingRangeFast divided by swingTimeFast';...
    'swingSpeedDiff',   'swingSpeedFast-swingSpeedSlow';...
    'swingSpeedSlowV2',   'stanceRangeSlow divided by stanceTimeSlow, the definition is on Brujin et al 2012';...
    'swingSpeedFastV2',   'stanceRangeFast divided by stanceTimeFast, the definition is on Brujin et al 2012';...
    'swingSpeedDiffV2',   'swingSpeedFastV2-swingSpeedSlowV2, the definition is on Brujin et al 2012';...
    'swingSpeedSlowV3',   'swingRangeSlow divided by swingTimeSlow with global coordinates';...
    'swingSpeedFastV3',   'swingRangeFast divided by swingTimeFast with global coordinates';...
    'swingSpeedDiffV3',   'swingSpeedFast-swingSpeedSlow in global coordinates'...
    %    'avgRotation',            'Angle that the coordinates were rotated by';...
%     'netContributionNorm2Alt',  'stepLengthDiff./stepLengthSlow+stepLengthFast';
    }; 
...
% alphaRatioFast=alphaFast./(alphaSlow+alphaFast);
%alpha ratios
alphaRatioSlow=alphaSlow./(stanceRangeSlow); %This is how it is define in the Malone Paper
alphaRatioFast=alphaFast./(stanceRangeFast);
...
% netContributionNorm2Alt=stepLengthDiff./Dist;
...
%Compute Swing speeds

swingTimeSlow=timeSHS2-timeSTO;
swingTimeFast=timeFHS-timeFTO;

swingSpeedSlow=swingRangeSlow./swingTimeSlow;
swingSpeedFast=swingRangeFast./swingTimeFast;
swingSpeedDiff=swingSpeedFast-swingSpeedSlow;


%Swing and Stance speed in the absolute frame
aux=markerData.getDataAsTS({[f 'ANKy'],[ s 'ANKy']}).getSample(eventTimes,'closest');
swingSpeedSlowV3=-(aux(:,SHS2,2)-aux(:,STO,2))./(timeSHS2-timeSTO);
swingSpeedFastV3=-(aux(:,FHS,1)-aux(:,FTO,1))./(timeFHS-timeFTO);

swingSpeedDiffV3=swingSpeedFastV3-swingSpeedSlowV3;

%Compute Swing Speed as Brujin et al 

stanceTimeSlow=timeSTO-timeSHS;
stanceTimeFast=timeFTO2-timeFHS;

swingSpeedSlowV2=stanceRangeSlow./stanceTimeSlow;
swingSpeedFastV2=stanceRangeFast./stanceTimeFast;
swingSpeedDiffV2=swingSpeedFastV2-swingSpeedSlowV2;
