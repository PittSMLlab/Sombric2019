function out = calcParameters(trialData,subData,eventClass,initEventSide, expData, parameterClasses)
...
if nargin<6 || isempty(parameterClasses)
...
if ~isempty(trialData.GRFData)
    [force] = computeForceParameters(strideEvents,trialData.GRFData,s, f, subData.weight, trialData.metaData, trialData.markerData, trialData.gaitEvents, expData, spat);
