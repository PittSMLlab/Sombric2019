function [rotatedMarkerData,sAnkFwd,fAnkFwd,sAnk2D,fAnk2D,sAngle,fAngle,direction,hipPos]=getKinematicData(eventTimes,markerData,angleData,s, trialType)
...
if isempty(trialType) || strcmp(trialType, 'OG') || direction(1)==-1
aux=sign(sAngle(:,1)); %Checks for sAngle(indSHS)<0 %CJS
