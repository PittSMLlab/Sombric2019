function results = getResultsPerceptionStudy(SMatrix,params,groups,maxPerturb,plotFlag,indivFlag, removeBias)
...
if nargin>4 && plotFlag
    epochs={'EarlyA', 'TMsteady','TMafter','DeltaAdapt','DeltaDeAdapt'};
