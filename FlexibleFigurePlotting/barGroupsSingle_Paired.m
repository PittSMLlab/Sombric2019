function barGroupsSingle_Paired(Study,results,groups,params,epochs,indivFlag,colorOrder,mode, row, col, sub)
...
%            abrevGroups{b}=[group(1) abrevGroup];
           ...
           switch mode
              ...
              for s=1:length(Study.(groups{b}).ID)
                  ...
                  %Plot Paired Data
                  DataTogether(s, b)=results.(epochs{t}).indiv.(params{p})(GroupIDPosition(s),2);
              end
       end
       plot([1.2, 1.8], DataTogether, '-o')
       switch mode
           case 1
