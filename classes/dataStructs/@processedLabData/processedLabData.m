classdef processedLabData < labData
    ...
    methods
        ...
        %Constructor:
        function this=processedLabData(metaData,markerData,EMGData,GRFData,beltSpeedSetData,beltSpeedReadData,accData,EEGData,footSwitches,events,procEMG,angleData,COPData,COMData,jointMomentsData, ppData) %All arguments are mandatory
...
%             end
        ...
        function [alignedField,originalDurations,bad,initTime,events]=getAlignedField(this,field,events,alignmentLengths)
            ...
            %[alignedField,originalDurations]=labTS.align(stridedField(~bad,:),alignmentLengths);
        end
    end
