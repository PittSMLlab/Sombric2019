classdef labTimeSeries  < timeseries
    ...
    methods
        ...
        function newThis=appendData(this,newData,newLabels) %For back compat
            other=labTimeSeries(newData,this.Time(1),this.sampPeriod,newLabels);%CJS I UPDATED THE ORDER
        ...
        function newThis=concatenate(this,other)
            ...
            if all(this.Time==other.Time)
                newThis=labTimeSeries([this.Data,other.Data],this.Time(1),this.sampPeriod,[this.labels, other.labels]);%OLD
